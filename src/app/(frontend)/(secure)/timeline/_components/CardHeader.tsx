...
export function CardHeader({ author, createdAt, type, menu }: CardHeaderProps) {
    return (
        <div className={styles.header}>
            {author.photoUrl ? (
                <img src={author.photoUrl} alt={author.username} className={styles.avatar} />
            ) : (
                <div className={styles.avatarFallback}>
                    {getInitials(null, author.username)}
                </div>
            )}

            <div className={styles.meta}>
                <div className={styles.nameRow}>
                    <span className={styles.displayName}>{author.username}</span>
